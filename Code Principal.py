...
ghost1 = Ghost.Ghost(130, 100, "right", "deeppink", (50, 60), screen, 2, pygame.Vector2(130, 100), pygame.Vector2(130, 290), pygame.Vector2(780, 290), pygame.Vector2(780, 100), bullet_manager)
ghost2 = Ghost.Ghost(550, 100, "right", "red", (50, 60), screen, 2, pygame.Vector2(130, 100), pygame.Vector2(130, 290), pygame.Vector2(780, 290), pygame.Vector2(780, 100), bullet_manager)
ghost3 = Ghost.Ghost(780, 290, "left", "deepskyblue", (50, 60), screen, 2, pygame.Vector2(130, 100), pygame.Vector2(130, 290), pygame.Vector2(780, 290), pygame.Vector2(780, 100), bullet_manager)
ghost4 = Ghost.Ghost(360, 290, "left", "orange", (50, 60), screen, 2, pygame.Vector2(130, 100), pygame.Vector2(130, 290), pygame.Vector2(780, 290), pygame.Vector2(780, 100), bullet_manager)

player = Player.Player(480, 655, "yellow", 40, screen, 9, bullet_manager)

# bullet_player = Bullet.Bullet(475, 650, "left", "yellow", (10, 10), screen, 12)
# bullet_ghost1 = Bullet.Bullet(150, 125, "left", "deeppink", (10, 10), screen, 7)
# bullet_ghost2 = Bullet.Bullet(570, 125, "left", "red", (10, 10), screen, 7)
# bullet_ghost3 = Bullet.Bullet(800, 315, "left", "deepskyblue", (10, 10), screen, 7)
# bullet_ghost4 = Bullet.Bullet(380, 315, "left", "orange", (10, 10), screen, 7)
...
while running == True:  # Tant que le jeu tourne, la variable est vrai
    ...
    bullet_manager.move_and_draw_ghost_bullets()
